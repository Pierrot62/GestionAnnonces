...
$newObj = new Utilisateurs(["nomUtilisateur" => "([value 1])", "prenomutilisateur" => "([value 2])", "emailUtilisateur" => "([value 3])", "pseudoUtilisateur" => "([value 4])", "mdpUtilisateur" => "([value 5])", "telUtilisateur" => "([value 6])", "idRole" => "([value 7])"]);
